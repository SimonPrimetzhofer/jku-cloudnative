...
# kubectl -n argocd patch secret argocd-secret -p ""{\"stringData\": {\"admin.password\": \"$2a$10$tvfB2u6E14fkR7.HZNQRqeI54.8O7OCw4ib06.Gr7ywSajplpcmOC\",\"admin.passwordMtime\": \"\"}}""
